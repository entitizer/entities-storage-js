...
RootControlService.prototype.setEntityEnglishWiki = function(data) {
	try {
		data = formatSetEntityData(data, ['id', 'wikiEnglishId', 'wikiEnglishName']);
	} catch (error) {
		return Promise.reject(error);
	}
	var params = data.params;
...
RootControlService.prototype.addEntityName = function(data) {};

RootControlService.prototype.deleteEntityName = function(data) {};
