 ...
 */
RootControlService.prototype.setEntityDetails = function(data) {
	try {
 ...
 * @param {Number} options.globalId - GlobalEntity id.
 * @param {Object} options.globalEntity - GlobalEntity object.
 * @param {String} options.lang - Language 2 letters code.
 * @param {String} options.country - Country 2 letters code.
 * @return {Object} Returns updated Entity object.
 */
RootControlService.prototype.setEntityName = function(data) {
	...
	return getEntity()
		.then(function(entity) {
			...
			return models.Entity.updateAsync(data, params)
				.then(function() {
					return getGlobalEntity(entity).then(function(globalEntity) {
						if (globalEntity) {
