...
RootControlService.prototype.createGlobalEntity = function(data) {
	data = GlobalEntity.create(data).normalize().getData();
...
RootControlService.prototype.updateGlobalEntity = function(data) {
	data = GlobalEntity.create(data, 'update').normalize().getData();
...
RootControlService.prototype.createEntity = function(data) {
	data = Entity.create(data).normalize().getData();
...
RootControlService.prototype.updateEntity = function(data) {
	data = Entity.create(data, 'update').normalize().getData();
