...
RootControlService.prototype.createGlobalEntity = function(data) {
	data = GlobalEntity.create(data).getData();
...
RootControlService.prototype.updateGlobalEntity = function(data) {
	...
	return models.GlobalEntity.updateAsync(data).then(get);
};
...
RootControlService.prototype.createEntity = function(data) {
	data = Entity.create(data).getData();
 ...
 */
RootControlService.prototype.updateEntity = function(data) {
	// data = Entity.create(data).getData();
	...
	// params.UpdateExpression = params.UpdateExpression.substr(params.UpdateExpression.length - 2);

	return models.Entity.updateAsync(data).then(get);
};
