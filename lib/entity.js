...
exports.getUpdateFields = function() {
	return UPDATE_FIELDS;
};

exports.selectUpdateFields = function(data) {
	return _.pick(data, UPDATE_FIELDS);
};

exports.selectCreateFields = function(data) {
	return _.pick(data, UPDATE_FIELDS);
};
...
var normalizeUpdate = exports.normalizeUpdate = function(entity) {
	if (!entity.lang || !entity.country) {
		throw new Error('`lang` AND `country` are required on update Entity');
	}
	var entityId = entity.id;
	entity = _.pick(entity, UPDATE_FIELDS);
	entity.id = entityId;
	if (entity.name) {
		entity.name = entity.name.trim();
		entity.name = utils.correctText(entity.name, entity.lang);
