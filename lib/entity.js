...
var ENTITY_NAME_TYPE = schemas.ENTITY_NAME_TYPE;
...
exports.normalizeCreate = function(entity) {
	...
	for (var i = 0; i < 60 && i < entity.names.length; i++) {
		...
		keys[lname] = true;
		name = EntityName.normalize(name, entity.lang, entity.country);
		names.push(name);
	}
...
exports.normalizeUpdate = function(entity) {
