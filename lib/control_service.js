 ...
 * @param {Object} options - Options for createEntityNameKeys
...
ControlService.prototype.createEntity = function(data, options) {
	...
	function createEntity() {
		return RootControlService.prototype.createEntity.call(this, data)
			.then(function(entity) {
				if (entity) {
					return self.createEntityNameKeysFromEntity(entity, options)
						.then(function() {
							return entity;
						});
				}
		...
		.then(function(entity) {
			...
			return Promise.props({
				...
				if (globalEntity) {
					...
					if (data.englishWikiDescription) {
						globalEntity.description = data.englishWikiDescription;
					}
