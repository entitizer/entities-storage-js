...
var BASE_ENTITY_ATTRIBUTES = ['id', 'name', 'type', 'slug', 'abbr', 'wikiId', 'wikiName', 'englishWikiId', 'category', 'region', 'country', 'lang', 'globalId'];
...
var BASE_GLOBAL_ENTITY_ATTRIBUTES = ['id', 'name', 'type', 'slug', 'abbr', 'englishWikiId', 'category', 'region', 'names', 'entities'];
...
AccessService.prototype.entityBySlug = function(params) {
	params.key = EntityName.createKey(params.slug, params.lang, params.country);
