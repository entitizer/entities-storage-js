 ...
 * @param {Object} params.params - DynamoDB params
 */
AccessService.prototype.nameKeyByKey = function(key, options) {
	options = buildOptions(options);
	return vogels.access.getItem('NameKey', key, options);
};
 ...
 * @param {Object} params.params - DynamoDB params
 */
AccessService.prototype.nameKeysByKeys = function(keys, options) {
	options = buildOptions(options);
	return vogels.access.getItems('NameKey', keys, options);
};
...
AccessService.prototype.entitiesByKeys = function(keys, options) {
	...
	return this.nameKeysByKeys(keys)
		.then(function(result) {
			var data = {};
